...
cookie ="FROM_TYPE=weixin; v=5.5; wechatSESS_ID=4ce725505e873e0357a2200da12b3f0a890618aa76a43783; Authorization=eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9.eyJ1c2VySWQiOjQwMjA0ODI1LCJzY2hJZCI6MjAwNTgsImV4cGlyZUF0IjoxNjk1NjI5NzQyfQ.HaiW8qLyIRTOVxjz7NAA5D4vSIFoELayGQ5D8qk5WRwU6Y9UEr7h7ZQzftxW6QtO1F8mW9ms8Il9IMB0Y6YWASRBXdUIpwYAudl5n9t1rDl8y-yT61dH_inF-QOKsI7eknYSMmU747YIhOkqzE3Gtz1QErQcJMPAj-hpmAEhNjfKTofWxbioq-0h_4HNRXe3RP2PHkcZ09ujTUhoHIUPxLLFoyqSrDKYvoewoL1tN0HLlVL82V6Jjg7R_HXqiom_Zu4UFp0aIN9yn6SM_ZqZB9xhIbC4MphmL9PdypJg5vrDbCo2w_UGygsYqUm9ImNNsRGrBOAstrWroxYxwiZ9Ag; Hm_lvt_7ecd21a13263a714793f376c18038a87=1695253225,1695272941,1695622544; Hm_lpvt_7ecd21a13263a714793f376c18038a87=1695622544; SERVERID=82967fec9605fac9a28c437e2a3ef1a4|1695622544|1695622538"
header= {
...
if __name__ == '__main__':
    ...
    ts = time.strftime("%Y-%m-%d", time.localtime(time.time() + 31536000))
    ...
    # print(libs)
    # for i in libs:
        # if i['lib_id'] == 114221 and i['is_open']:
            # print(i['lib_name'])
            # print(libs.index(i))
    # print(libs[1]['lib_name'])
