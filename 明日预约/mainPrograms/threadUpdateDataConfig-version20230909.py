...
def switchData():
    ...
    BeforeConfigList[0]['openTime']=configDict['user']['openTime']
    BeforeConfigList[0].get('header')['Cookie']=configDict['user']['Cookie']
    BeforeConfigList[0].get('queue_header')["Cookie"] = configDict['user']['Cookie']
